# Here to execute before Instant Prompt is activated
export GPG_TTY=$(tty)
...
alias ipmi-pve1="ipmitool -I lanplus -U root -P admin800 -H 10.20.0.4 shell"
alias ipmi-pve1-fans="ipmitool -I lanplus -U root -P admin800 -H 10.20.0.4 raw 0x30 0x30 0x01 0x00 && ipmitool -I lanplus -U root -P admin800 -H 10.20.0.4 raw 0x30 0x30 0x02 0xff 0x05"
